...
namespace com.cyberinternauts.csharp.CmdStarter.Tests.Commands.Attributes.AutoComplete.Factories
{
    internal sealed class AutoCompleteOptionFactory : IAutoCompleteFactory<string>
    {
        ...
        public Func<string, string> LabelFactory => (str) => str.PascalToKebabCase();
    ...
    internal sealed class AutoCompleteArgumentFactory : IAutoCompleteFactory<int>
    {
        ...
        public Func<int, string> LabelFactory => (num) => num.ToString();

        public Func<int, string?> DocumentationFactory => (num) =>
        {
